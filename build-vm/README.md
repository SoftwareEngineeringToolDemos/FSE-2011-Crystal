...
4. Clone this repository in the host.
5. Then cd into the directory that contains the Vagrantfile and run the command "vagrant up".
6. The command "vagrant up" will create a Ubuntu (64-bit) VM with Java installed in it.
